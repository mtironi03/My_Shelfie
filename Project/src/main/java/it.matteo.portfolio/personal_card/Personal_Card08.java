...
/**
 * Classe concreta che rappresenta la carta Obiettivo Personale n.8.
...
public class Personal_Card08 extends Personal_Card {
	...
	/**
	 * Costruisce l'oggetto Personal_Card08. 
	...
	public Personal_Card08() {
		...
		targetPositions.add(new Tile(new Position(3, 2), Color.LIGHT_BLUE));
		targetPositions.add(new Tile(new Position(0, 3), Color.YELLOW));
		targetPositions.add(new Tile(new Position(1, 3), Color.WHITE));
		targetPositions.add(new Tile(new Position(4, 1), Color.GREEN));
		targetPositions.add(new Tile(new Position(2, 0), Color.PINK));
		targetPositions.add(new Tile(new Position(5, 4), Color.BLUE));
	}
}
