...
/**
 * Classe concreta che rappresenta la carta Obiettivo Personale n.12.
...
public class Personal_Card12 extends Personal_Card {
	...
	/**
	 * Costruisce l'oggetto Personal_Card12. 
	...
	public Personal_Card12() {
		...
		targetPositions.add(new Tile(new Position(2, 3), Color.LIGHT_BLUE));
		targetPositions.add(new Tile(new Position(1, 4), Color.YELLOW));
		targetPositions.add(new Tile(new Position(5, 2), Color.WHITE));
		targetPositions.add(new Tile(new Position(0, 0), Color.GREEN));
